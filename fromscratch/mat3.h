...
public:
    ...
    mat3 inverse(){
        ...
        mat3 out;
        out << _det({1,1}, {1, 2}, {2, 1}, {2, 2}) 
            << _det({0,2}, {0, 1}, {2, 2}, {2, 1})
            << _det({0,1}, {0, 2}, {1, 1}, {1, 2})
            << _det({1,2}, {1, 0}, {2, 2}, {2, 0})  
            << _det({0,0}, {0, 2}, {2, 0}, {2, 2})
            << _det({0,2}, {0, 0}, {1, 2}, {1, 0})  
            << _det({1,0}, {1, 1}, {2, 0}, {2, 1}) 
            << _det({0,1}, {0, 0}, {2, 1}, {2, 0}) 
            << _det({0,0}, {0, 1}, {1, 0}, {1, 1})
            ;

        double determinent = this->det();
        return out / determinent;
    }
